            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <form class="forms-sample" action="{{route('store_UpdateD_boy', $d_boy->dboy_id)}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="boy_name" class="form-control" value="{{$d_boy->boy_name}}">
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="boy_phone" class="form-control" value="{{$d_boy->boy_phone}}">
                        </div>
                      </div>
                    </div>
                      <div class="row">
                        ...
                        <div class="form-group">
                          <label class="bmd-label-floating">{{ __('keywords.Select')}} {{ __('keywords.ID')}}</label>
                            <select name="id_name" class="form-control" required>
                              ...
                              <option value="{{$taxes->name}}" @if($taxes->name== $d_boy->id_name) selected @endif</option>)>{{$taxes->name}}</option>
                               @endforeach
                          </select>
                        </div>
                    </div>
                     ...
                     <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="password" class="form-control" value="{{$d_boy->password}}">
                        </div>
                      </div>
                    @if($mapset->mapbox == 0 && $mapset->google_map == 1)
                            <div class="col-md-6">
                           <div class="form-group">
                            ...
                            <input type="text" name="boy_loc" id="autocomplete" class="form-control" value="{{$d_boy->boy_loc}}">
                        </div>
                          </div>
                     ...
                     @if($mapset->mapbox == 1 && $mapset->google_map == 0) 
                       ...
                       <div class="autocomplete" style="width:100%;">
                           <input id="lng" type="hidden" name="lng" value="{{$d_boy->lng}}">
                            ...
                            <input id="myInput" type="text" name="boy_loc" value="{{$d_boy->boy_loc}}">
                        </div>
                         </div>
                          </div>
                      @endif
                    ...
                    <a href="{{route('store_d_boylist')}}" class="btn">{{ __('keywords.Close')}}</a>
