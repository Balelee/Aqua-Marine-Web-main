...
<div class="card-header card-header-primary">
      <h4 class="card-title">{{ __('keywords.Delivery Boy')}} (<b>{{$dboy->boy_name}})</b> {{ __('keywords.Order')}} {{ __('keywords.List')}}</h4>
...
<table id="datatableDefault" class="table table-striped text-nowrap w-100">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ \Carbon\Carbon::parse($ords->delivery_date)->translatedFormat('d-m-Y') }}</td>
        		...
        		<div class="modal-content">
        			...
        			<div class="row">
                      ...
                      <div class="col-md-6" align="center">
        			    ...
        			    @if($ords->store_id == $nearbydboys->store_id)
