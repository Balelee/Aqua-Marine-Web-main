...
<div class="card-header card-header-primary">
      <h4 class="card-title ">{{ __('keywords.Payment Failed orders')}}</h4>
    </div>
...
<table id="datatableDefault" class="table table-striped text-nowrap w-100">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ \Carbon\Carbon::parse($ords->delivery_date)->translatedFormat('d F Y') }} à {{$ords->time_slot}}</td>
             <td><p><span class="dot" style="color:red"></span><b style="color:red">{{ __('keywords.Payment Failed')}}</b></p></td>
