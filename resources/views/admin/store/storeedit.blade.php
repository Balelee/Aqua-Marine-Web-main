          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form class="forms-sample" action="{{route('storeupdate', $store->id)}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                        <div class="form">
                           <label> {{ __('keywords.Select City')}}</label>
                     ...
                     @if($mapset->mapbox == 1 && $mapset->google_map == 0) 
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="number" name="orders" value="{{$store->orders}}" class="form-control" placeholder="Order Per Time Slot">
                        </div>
                      </div>
                    </div><br>
