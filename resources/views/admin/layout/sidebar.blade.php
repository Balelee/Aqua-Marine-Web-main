...
<div id="sidebar" class="app-sidebar">
    ...
    <div class="app-sidebar-content" data-scrollbar="true" data-height="100%">
        ...
        <div class="menu">
            ...
            <div class="menu-item  has-sub {{ request()->is('story/*') ? 'active' : ''}}"">
                <a href="#" class="menu-link">
							<span class="menu-icon">
								<i class="fa fa-bell"></i>
							</span>
                    <span class="menu-text">{{ __('Stories') }}</span>
                    <span class="menu-caret"><b class="caret"></b></span>
                </a>
                <div class="menu-submenu">
                    <div class="menu-item {{ request()->is('story/send') ? 'active' : ''}}">
                        <a href="{{route('adminStorySend')}}" class="menu-link">
                            <span class="menu-text">{{ __('Créer une Stories') }}</span>
                        </a>
                    </div>
                    <div class="menu-item {{ request()->is('story/list') ? 'active' : ''}}">
                        <a href="{{route('adminStoryList')}}" class="menu-link">
                            <span class="menu-text">{{ __('Voire mes Stories')}}</span>
                        </a>
                    </div>
            ...
            <div class="menu-item has-sub {{ request()->is('about_us') ? 'active' : ''}} {{ request()->is('terms') ? 'active' : ''}}">
                ...
                <div class="menu-submenu">
                    ...
                    <div class="menu-item {{ request()->is('privacys') ? 'active' : ''}}">
                        <a href="{{route('privacys')}}" class="menu-link">
