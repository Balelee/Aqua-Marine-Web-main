...
<head>
	...
	<meta name="description" content="Multistore" />
	<meta name="author" content="DHGROUPE" />
        ...
        <div class="row">
            ...
            <div class="col-md-4" align="right">
                <select class="form-control changeLang">
                    ...
                    <option value="fr" {{ session()->get('locale') == 'fr'||config('app.locale')=="fr" ? 'selected' : '' }}>Français</option>
                </select>
            </div></div></div>
                 @yield('content')
             </div>
