...
use App\Http\Controllers\DeliveryAdressController;
...
Route::namespace("Api")->prefix('')->group(function () {
    ...
    Route::get('/list-stories', [ApiStoryController::class, 'get_stories'])->name('api.get_stories');
    Route::get('/stories/{id}', [ApiStoryController::class, 'show']);
    Route::post('/stories/{id}/seen', [ApiStoryController::class, 'markAsSeen']);
    Route::delete('/stories/{id}', [ApiStoryController::class, 'destroy']);
...
Route::group(['prefix'=>'store', ['middleware' => ['XSS']], 'namespace'=>'Storeapi'], function(){
    ...
    Route::post('storeall_orders', [StoreorderController::class,'pastorders']);
...
Route::get('/reaction-status', [ReactionController::class, 'getReactionStatus']);
Route::post('/react', [ReactionController::class, 'react']);
Route::post('/comment', [CommentController::class, 'storeComment']);
Route::get('/comments/{productId}', [CommentController::class, 'getCommentsByProduct']);
Route::post('/delivery-addresses', [DeliveryAdressController::class, 'store']);
