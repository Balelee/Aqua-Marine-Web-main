...
class RewardController extends Controller
{
    ...
    public function rewardlines(Request $request)
    {
        ...
        $text1 = "Vous recevrez ".$cc->reward_point * $reward_point." points de fidélité après la validation de cette commande.";
        ...
        if($cc2){
            ...
            $text2="Ajoutez des articles pour un total de ".$nu." ".$currency->currency_sign." de plus afin d'obtenir ".$cc2->reward_point * $reward_point." points de fidélité.";
        }
        else{
            $text2 = "";
        }
