       ...
       $nearbystore = DB::table('store')
        ...
        if($nearbystore->del_range >= $nearbystore->distance) {
           if($nearbystore->store_status == 1){
            $message = array('status'=>'1', 'message'=>'Magasin Trouvé à votre emplacement', 'data'=>$nearbystore);
            return $message;
           }
           else{
                $message = array('status'=>'2', 'message'=>'Le magasin est fermé', 'data'=>$nearbystore);
            return $message;
           }
        }
        else{
            ...
            $message = array('status'=>'0', 'message'=>'Nous ne livrons pas votre région. nous servons dans '.$city_name.' seulement');
            return $message;
        }
